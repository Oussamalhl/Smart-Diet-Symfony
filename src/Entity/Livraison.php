 ...
 * Livraison
 *
 * @ORM\Table(name="livraison", indexes={@ORM\Index(name="idComm", columns={"idCommande"}), @ORM\Index(name="idLivreur", columns={"idLivreur"}), @ORM\Index(name="idPayment", columns={"idPayment"})})
...
class Livraison
{
    ...
    public function setIdpayment(?Payment $idpayment): self
    {
